...
@section('content')
    <div class="card mb-4 col-md-7">
        ...
        <form action="{{ route('sport-events.store') }}" method="POST">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-0 @error('date') is-invalid @enderror" type="date" id="date"
                        name="date" placeholder="Event Date" value="{{ old('date') }}" required>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-0 @error('name') is-invalid @enderror" name="name" id="name"
                        name="name" placeholder="Event Name" value="{{ old('name') }}" required>
                    @error('name')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-0 @error('type') is-invalid @enderror" type="text" id="type"
                        name="type" placeholder="Event Type" value="{{ old('type') }}" required>
                    @error('type')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-0 @error('organizer_id') is-invalid @enderror" name="organizer_id"
                        id="organizer_id" name="organizer_id" placeholder="Organizer Id" value="{{ old('organizer_id') }}"
                        required>
                    @error('organizer_id')
                        <span class="invalid-feedback">
                            {{ $message }}
